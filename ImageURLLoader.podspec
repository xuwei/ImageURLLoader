#
#  Be sure to run `pod spec lint ImageURLLoader.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ImageURLLoader"
  spec.version      = "1.0.0"
  spec.summary      = "ImageURLLoader is an utility class to simplify loading of image by imageURL."
